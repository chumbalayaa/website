...
( function( $ ) {
	...
	function initHomepageNav(){
		...
		$('<div/>', {
		    'id' : 'slideNav'
		}).append($('<ul><li class="slideNavPrev"><a class="disabled" href="#" title="Go to previous slide"><span class="glyphicon glyphicon-arrow-up"></span></a></li><li><span id="activeSlide">'+activeSlide+'</span>/<span id="maxSlides">'+slidesCount+'</span></li><li class="slideNavNext"><a href="#" title="Go to next slide"><span class="glyphicon glyphicon-arrow-down"></span></a></li></ul>')).appendTo('body').delay(1200).fadeIn(duration);
